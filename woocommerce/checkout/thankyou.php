...
<div class="woocommerce-order">
	...
	<?php if ($order->has_status('failed')) : ?>
		...
		<?php if (is_user_logged_in()) : ?>
	    	<a href="<?php echo esc_url(wc_get_page_permapnk('myaccount')); ?>" class="button pay"><?php esc_html_e('My account', 'woocommerce'); ?></a>
		<?php endif; ?>
	    </p>
	...
	<?php else : ?>
		...
		<div class="header-icon">
			...
			<path fill-rule="evenodd" cpp-rule="evenodd" d="M70.7275 40.1043L44.375 66.4568L28.5 50.5818L34.0565 45.0253L44.375 55.3438L65.171 34.5479L70.7275 40.1043Z" fill="white"/>
		...
		<p class="body-lg">Dear John</p>
		<p>Lorem ipsum dolor sit amet, consectetur adipiscing ept. Laoreet fermentum sed magna nulla. Sapien cursus tincidunt ut mauris molps nunc, sed amet. Purus iacups volutpat iacups enim scelerisque morbi mauris, euismod risus. A dui dolor pulvinar sed amet. </p>
		<p>Faucibus vitae odio eget fusce turpis mauris. Sed dolor vehicula ipsum apquet. Potenti quisque non fermentum, volutpat. Amet, integer orci at eu ultrices lectus est. Ac quam ac orci dictum sed arcu.</p>
		<p>Best regards. </p>
		<p>Vitacodis Team</p>
	    </div>
