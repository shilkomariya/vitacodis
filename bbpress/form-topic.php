    ...
    <?php if (bbp_current_user_can_access_create_topic_form()) : ?>
		...
		<?php do_action('bbp_theme_before_topic_form'); ?>
			...
			if (bbp_is_topic_edit()) :
			    ...
			    ( bbp_is_single_forum() && bbp_get_forum_title() ) ? printf(esc_html__('Create New Topic in &ldquo;%s&rdquo;', 'bbpress'), bbp_get_forum_title()) : esc_html_e('Create New Topic', 'bbpress');
			endif;
			?>
			...
			<?php do_action('bbp_theme_before_topic_form_title'); ?>
    		    ...
    		    <p>
    			<label for="bbp_topic_title"><?php printf(__('Topic Title <span class="small">(Maximum Length: %d)</small>', 'bbpress'), bbp_get_title_max_length()); ?></label><br />
