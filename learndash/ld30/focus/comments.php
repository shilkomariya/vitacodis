...
<div class="ld-focus-comments">
    ...
    ?>
    <div class="ld-focus-comments__form-container<?php echo esc_attr( $learndash_comment_form_state ); ?>" id="ld-comments-form" style="display: block">
        <?php
        /**
        ...
        $args = apply_filters(
            ...
            array(
                'title_reply' => esc_html__( 'Leave a Commentss', 'learndash' ),
            )
        );
